...
/* Full source can be found in invoice.css */
 .div-align-right {float: right;}.div-align-right .maybe-align-right {text-align: right }.entries-table * {border-width: 1px;border-style:solid;border-collapse: collapse}.entries-table > table {width: 100% }.company-table > table * {padding: 0px;}.client-table > table * {padding: 0px;}.invoice-details-table > table * {padding: 0px;}.invoice-in-progress {visibility:hidden;}.invoice-details-table > table {display: block;}.invoice-notes {margin-top: 20px }.entries-table > table {min-width: 600px }.entries-table tr:nth-child(odd) {background-color: lightgray;}td.number-cell {font-size: 12px;}body, p, table, tr, td {font-size: 14px;}.main-table > table {margin: auto;min-height: 100vh;}@media print {.main-table > table {min-width: 100vw;}}.invoice-details-table {background-color: #4a9f99;padding: 16px;}.invoice-details-table > table * {color: white;}.invoice-details-table > table > tbody > tr > td:last-child {padding-left: 29px;}.invoice-title {font-weight: bold;text-transform: uppercase;color: #548b88;font-size: x-large;}.entries-table > table > thead > tr > th {padding: 16px;}body > div > table > tbody > tr > td {padding-top: 28px;padding-left: 0;padding-right: 0;}body > div > table > tbody > tr:first-child {background-color: #1d6e6a;color: white;}body > div > table > tbody > tr:last-child {background-color: #424141;color: white;}body > div > table > tbody > tr:last-child > td, body > div > table > tbody > tr:first-child > td {padding: 24px;}.invoice-notes-extra {margin-top: 0;}@media print {body > div > table > tbody > tr:nth-child(2) > td:first-child, body > div > table > tbody > tr:nth-child(3) > td:first-child {padding-left: 48px;}}.entries-table td {padding: 10px 28px;}.entries-table * {border: none;}.entries-table > table > thead > tr > th:first-child {text-align: start !important;padding-left: 28px;}.entries-table > table > thead > tr > th:not(:first-child) {text-align: end;}.entries-table > table > thead > tr {background-color: #548b88 !important;color: white !important;}.total-number-cell {color: #548b88;}.total-label-cell {text-align: end;}.client-name {font-weight: bold;}html, body {margin: 0;}
")
